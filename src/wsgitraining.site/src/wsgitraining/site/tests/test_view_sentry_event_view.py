...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_sentry_event_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='sentry-event-view'
        )
        self.assertTrue(view.__name__ == 'sentry-event-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in sentry-event-view'
        # )

    def test_sentry_event_view_not_matching_interface(self):
