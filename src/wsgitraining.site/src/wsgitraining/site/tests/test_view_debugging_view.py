...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_debugging_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='debugging-view'
        )
        self.assertTrue(view.__name__ == 'debugging-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in debugging-view'
        # )

    def test_debugging_view_not_matching_interface(self):
