...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_long_request_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='long-request-view'
        )
        self.assertTrue(view.__name__ == 'long-request-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in long-request-view'
        # )

    def test_long_request_view_not_matching_interface(self):
